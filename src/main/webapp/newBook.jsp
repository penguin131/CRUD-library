...
<html:form action="/AddBook" method="post">
    <table>
        <tr>
            <td class="bookValidation"><html:errors property="numbers" /></td>
        </tr>
        <tr>
            <td class="bookValidation"><html:errors property="length" /></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="bookValidation"><html:errors property="year" /></td>
        </tr>
        <tr>
            <td>Cost: <html:text name="AddBookForm" property="cost"/></td>
            <td class="bookValidation"><html:errors property="cost" /></td>
        </tr>
        <tr><td>
